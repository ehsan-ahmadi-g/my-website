...
import Image1 from '../../assets/images/optimal360/1.png'
import Image2 from '../../assets/images/optimal360/2.png'
import Image3 from '../../assets/images/optimal360/3.png'
import Image4 from '../../assets/images/optimal360/4.png'
import Image5 from '../../assets/images/optimal360/5.png'
...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>{Resume.projects.optimal360.name}</title>
        ...
        <div className="grid grid-cols-2 gap-x-4">
          {[Image2, Image3].map((imgSrc, i) => (
            <div key={i} className="col-span-2 lg:col-span-1 mx-3 my-3 lg:my-6">
              <Image className="rounded" src={imgSrc} alt="header" />
            </div>
          ))}
        </div>
